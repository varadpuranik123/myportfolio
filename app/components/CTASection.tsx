...
const CTASection = () => {
    return (
        <section className='w-full min-h-64 border-b border-[#82A891] flex flex-col gap-6 items-center justify-center relative font-sans pb-4'>
            <div
                className={cn(
                    "absolute inset-0",
                    "[background-size:40px_40px]",
                    "[background-image:linear-gradient(to_right,#82A89160,transparent_1px),linear-gradient(to_bottom,#82A89160,transparent_1px)]",
                    "linear-gradient(to_bottom,#82A89640,transparent_1px)]"
                    ,"mask-radial-from-0% "
                )}
                aria-hidden
            />

            <Heading className='capitalize text-center '>Open to meaningful design and development work.</Heading>
